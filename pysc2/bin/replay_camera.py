...
import numpy as np
from pysc2.analysis import gng
    ...
    while True:
      ...
      for action in obs.actions:
        ...
        if act_fl.HasField("camera_move"):
          model.addSample (np.array([act_fl.camera_move.center_minimap.x,act_fl.camera_move.center_minimap.y]))
      ...
      if obs.player_result:
        print("GNG Model State for replay " + str(self.stats.replay) + " player " + str(player_id))
        model.printState ()
        break
